...
import sys
import os
# Subimos 3 niveles: client.py -> client/ -> federated_docker/ -> OBJETIVO2/
ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Añadimos al path (es buena práctica comprobar que no esté ya)
...
class PVClient(fl.client.NumPyClient):
    ...
    def get_parameters(self, config=None):
        """
        Devuelve una copia independiente de los parámetros del modelo
        en formato NumPy, evitando aliasing de memoria con los tensores de PyTorch.
        """
