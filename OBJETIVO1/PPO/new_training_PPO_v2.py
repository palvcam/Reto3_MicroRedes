...
def make_env(seed=0):
    def _init():
        ...
        env = CustomEnvContinuousv2(
            ...
            low_soc_penalty=1.0, low_soc_threshold=0.20,
...
def objective(trial: optuna.Trial):
    ...
    ruta_logs = ruta_script / "logs" / "logs_optuna_PPO_v2_fast"
...
if __name__ == "__main__":
    ...
    study_name = "ppo_microgrid_v2"
    storage_name = f"sqlite:///{ruta_script}/optuna_ppo_v2.db"
